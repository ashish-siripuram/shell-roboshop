...
trap 'echo "Their is an error in $LINENO, Command is: $BASH_COMMAND"' ERR
...
SCRIPT_DIR=$PWD
MONGODB_HOST=mongodb.sak123.fun
...
if [ $INDEX -le 0 ]; then
    ...
    echo -e "Catalogue products already loadded ... $Y SKIPPING $N"
fi
